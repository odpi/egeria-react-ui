...
const InstancesContextProvider = (props) => {
 ...
 /*
  ...
  const changeFocusEntity = useCallback(
    ...
    [focus, guidToGenId, gens, clearFocusInstance, loadEntityFromSpecifiedServer ]
  );
  ...
  const changeFocusRelationship = useCallback(
    ...
    [clearFocusInstance, focus.instanceGUID, gens, guidToGenId, loadRelationshipFromSpecifiedServer]
  );
  ...
  const explore = useCallback(
    ( selectedEntityTypes, selectedRelationshipTypes, selectedClassificationTypes ) => {
